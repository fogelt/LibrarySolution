...
public class LoanTests
{
  ...
  public void IsOverdue_ShouldReturnFalse_WhenDueDateIsInFuture()
  {
    ...
    var loan = new Loan(book, member, DateOnly.FromDateTime(DateTime.Now), DateOnly.FromDateTime(DateTime.Now.AddDays(14)));
  ...
  public void IsReturned_ShouldReturnTrue_WhenReturnDateIsSet()
  {
    var book = new Book("123", "Test", "Author", 2024);
    var member = new Member("1", "Alice", "a@test.com", DateTime.Now, [], 10);
    var loan = new Loan(book, member, DateOnly.FromDateTime(DateTime.Now), DateOnly.FromDateTime(DateTime.Now)) { ReturnDate = DateOnly.FromDateTime(DateTime.Now) };
